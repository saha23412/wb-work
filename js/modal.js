...
selectButton.addEventListener("click",()=>{
    ...
    paymentMethodImg.forEach(image=>image.src = `./images/icons/${paymentMethod.value}.svg`)
    modalDeliveryElement.style.display = 'none'
    modalOverlay.style.display = 'none'
    document.querySelector('.modals').style.display = 'none'
    basketElement.classList.remove('background')
...
streetButton.addEventListener("click",()=>{
    ...
    street.forEach(streetText=>streetText.innerHTML=`${streetChecked.value}`)
