...
const accordionMissingProduct = document.querySelector(
    ".accordion__content-missing-product"
);
const accordionProductButton = document.querySelector(
    ".accordion__button-product"
);
const accordionMissingProductButton = document.querySelector(
    ".accordion__button-missing-product"
);
...
accordionProductButton.addEventListener("click", () => {
    ...
    if (flagAccordionProduct) {
        ...
        accordionInfoText.innerHTML = `  ${formatNumber(
            productInformation.amountProduct
        )} товаров · ${formatNumber(productInformation.priceProduct)} сом`;
